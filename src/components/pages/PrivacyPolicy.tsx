export const PrivacyPolicy = () => (
  <div className="max-w-4xl mx-auto px-6 py-20 text-thryve-cream prose prose-invert">
    ...
    <p>This page contains our privacy policy in both English and Dutch. The Dutch version follows the English version below.</p>
    ...
    <p>The Thryve Method<br/>Email: info@thethryvemethod.com<br/>Website: www.thethryvemethod.com<br/>Chamber of Commerce: 74191187<br/>http://www.thethryvemethod/</p>
    <hr/>
    ...
    <p>The Thryve Method<br/>E-mail: info@thethryvemethod.com<br/>Website: www.thethryvemethod<br/>KvK: 74191187</p>
  </div>
);
