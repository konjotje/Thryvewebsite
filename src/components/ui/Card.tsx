...
export const Card = ({ children, className = "", ...props }: CardProps) => {
  return (
    <div className={`relative p-[2px] rounded-3xl bg-gradient-to-br from-white/30 via-emerald-500/20 to-transparent shadow-[0_20px_50px_rgba(0,0,0,0.7)] ${className}`} {...props}>
